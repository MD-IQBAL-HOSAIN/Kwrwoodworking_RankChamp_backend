                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Setup your system, please <code>provide your valid
                                data</code>.</p>
                        <div class="mt-4">
                            <form class="forms-sample" method="POST" action="{{ route('admin.system.update') }}"
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col">
                                        ...
                                        <input type="file"
                                            ...
                                            name="logo"
                                            data-default-file="@isset($setting){{ $setting->logo }}@endisset">
                                        @error('logo')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="file"
                                            ...
                                            name="favicon"
                                            data-default-file="@isset($setting){{ $setting->favicon }}@endisset">
                                        @error('favicon')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
