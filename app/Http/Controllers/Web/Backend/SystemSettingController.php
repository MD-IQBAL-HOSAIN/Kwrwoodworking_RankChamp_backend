    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('favicon')) {
                $image = $request['favicon']->getClientOriginalName();
                $imagePath = '/system/favicon/' . time() . '_' . $image;  // Unique image path with timestamp
                $request['favicon']->move(public_path('/system/favicon/'), $imagePath);
